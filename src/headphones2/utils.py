...
def get_releases_for_release_group(release_group_id, includes='recordings', wanted_keys=('barcode', 'title','country','medium-list','date','id','asin')):
    search_results = musicbrainzngs.browse_releases(release_group=release_group_id, release_type='album', includes=[includes])['release-list']
